...
export const Home = () => {
    const {statusColor, setContext}=useContext(Context)
  ...
  return (
    <div className='flex justify-center'>
        ...
        <div className='flex flex-col justify-center w-full md:w-1/2'>
           <h1 className='text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-stone-800 mb-3 md:mb-5 text-center'>Welcome  To free Resume Builder</h1>
           <p className='text-sm md:text-base lg:text-xl xl:text-2xl text-stone-800 mb-4 text-center'>
            ...
            <div className='flex justify-center flex-col items-center gap-9'>
