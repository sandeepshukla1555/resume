       ...
       <div className='flex justify-between items-center absolute top-3 md:top-5 w-full px-2 md:px-5'>
        ...
        <div className='flex justify-between items-center w-[75%] md:w-[60%]'>
            <ul className='flex md:justify-between gap-1 overflow-scroll flex-nowrap w-[70%]'>
              ...
              <li><Link to='/update' className='text-sm md:text-lg text-stone-50'>Update</Link></li>
              <li><Link to='/download' className='text-sm md:text-lg text-stone-50'>Download</Link></li>
              <li><Link to='/signin' className='text-sm md:text-lg text-stone-50'>{locals===null?'Sign-in':<span onClick={()=>{
                locals.removeItem('resume')
              }}>Log-out</span>}</Link></li>
            </ul>
